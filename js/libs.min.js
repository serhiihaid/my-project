!(function (e, t) {
  ...
  var f = (function (n) {
    ...
    try {
      N.apply((t = I.call(b.childNodes)), b.childNodes),
      ...
      if (!i && (T(e), (e = e || C), S)) {
        if (11 !== p && (l = te.exec(t)))
          if ((o = l[1])) {
            ...
            } else if (u && (r = u.getElementById(o)) && y(e, r) && r.id === o)
              return n.push(r), n;
          } else {
        ...
        if (
          ...
          if (((d = t), (u = e), 1 === p && (Y.test(t) || U.test(t)))) {
            for (
              ((u = (ne.test(t) && ge(e.parentNode)) || e) === e && f.scope) ||
                ((a = e.getAttribute("id"))
                  ? (a = a.replace(oe, se))
    ...
    ((w = ae.selectors =
      {
                    ...
                    if (((l = [y ? d.firstChild : d.lastChild]), y && p)) {
                      ...
                      (p &&
                        (f = a =
                          (i =
                            (o =
                              (s = (r = e)[_] || (r[_] = {}))[r.uniqueID] ||
                              (s[r.uniqueID] = {}))[h] || [])[0] === k && i[1]),
                      !1 === f)
                    )
                      for (
                        ;
        ...
        pseudos: {
          ...
          lang: ce(function (n) {
            return (
              Q.test(n || "") || ae.error("unsupported lang: " + n),
            ...
            if (n) {
              ...
              for (; (e = e[l]); )
                if (1 === e.nodeType || u)
                  if (
                    ((o =
                      (s = e[_] || (e[_] = {}))[e.uniqueID] ||
                      (s[e.uniqueID] = {})),
                    c && c === e.nodeName.toLowerCase())
                  )
                    e = e[l] || e;
                  else {
                    if ((i = o[d]) && i[0] === k && i[1] === p)
                      return (r[2] = i[2]);
    ...
    function Te(m, v) {
      function e(e, t, n, i, o) {
        ...
        for (o && (x = t == C || t || o); c !== g && null != (s = f[c]); c++) {
          if (b && s) {
            for (
              r = 0, t || s.ownerDocument == C || (T(s), (n = !S));
              (a = m[r++]);
    ...
    return (
              ...
              (s = (function e(t) {
                for (
                  ...
                  if ((n = w.relative[t[l].type])) u = [ye(be(u), n)];
                    ...
                    if (
                      (n = w.filter[t[l].type].apply(null, t[l].matches))[_]
                    ) {
                      for (i = ++l; i < s && !w.relative[t[i].type]; i++);
                      return xe(
                        1 < l && be(u),
                        1 < l &&
                          ve(
        ...
        function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === d.length)) {
            if (
              ...
              if (!(t = (w.find.ID(r.matches[0].replace(ie, u), t) || [])[0]))
                return n;
            ...
            for (
              ...
              if (
                ...
                (i = l(
                  ...
                  (ne.test(s[0].type) && ge(t.parentNode)) || t
                ))
              ) {
      ...
      (f.sortStable = _.split("").sort(D).join("") === _),
  ...
  (_.filter = function (e, t, n) {
    ...
    _.fn.extend({
      ...
      is: function (e) {
        return !!A(this, "string" == typeof e && k.test(e) ? _(e) : e || [], !1)
          .length;
      },
    });
  var P,
  ...
  ((_.fn.init = function (e, t, n) {
    ...
    if (i[1]) {
      if (
        ...
        _.merge(
          this,
          _.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : S, !0)
        ),
      ...
      function (i, o) {
        _.fn[i] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (L[i] || _.uniqueSort(n), O.test(i) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (_.Callbacks = function (i) {
    ...
    _.extend({
                ...
                return function () {
                      ...
                      : function () {
                          try {
                            ...
                            _.Deferred.exceptionHook &&
                              _.Deferred.exceptionHook(e, t.stackTrace),
                              l <= o + 1 &&
                                (r !== H && ((n = void 0), (i = [e])),
                                s.rejectWith(n, i));
                          }
                  ...
                  o
                    ...
                    : (_.Deferred.getStackHook &&
                        (t.stackTrace = _.Deferred.getStackHook()),
                      C.setTimeout(t));
                };
              }
              return _.Deferred(function (e) {
                s[0][3].add(c(0, e, b(i) ? i : I, e.notifyWith)),
                  s[1][3].add(c(0, e, b(t) ? t : I)),
                  s[2][3].add(c(0, e, b(n) ? n : H));
              }).promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          n <= 1 &&
          (M(e, r.done(t(i)).resolve, r.reject, !n),
          "pending" === r.state() || b(s[i] && s[i].then))
        )
          return r.then();
        for (; i--; ) M(s[i], t(i), r.reject);
        return r.promise();
      },
    });
  ...
  _.extend({
    ...
    _.fn.extend({
      data: function (n, e) {
          ...
          return "object" == typeof n
            ...
            : z(
                ...
                function (e) {
                  var t;
                  return s && void 0 === e
                    ? void 0 !== (t = K.get(s, n)) || void 0 !== (t = J(s, n))
                      ? t
                      : void 0
        ...
        if (
          this.length &&
          ((o = K.get(s)), 1 === s.nodeType && !Q.get(s, "hasDataAttrs"))
        ) {
          for (t = r.length; t--; )
            r[t] &&
              0 === (i = r[t].name).indexOf("data-") &&
              ((i = U(i.slice(5))), J(s, i, o[i]));
  ...
  ie.getRootNode &&
    (oe = function (e) {
      return (
        _.contains(e.ownerDocument, e) || e.getRootNode(se) === e.ownerDocument
      );
    });
  var re = function (e, t) {
    return (
      "none" === (e = t || e).style.display ||
      ("" === e.style.display && oe(e) && "none" === _.css(e, "display"))
    );
  };
  function ae(e, t, n, i) {
    var o,
            ...
            "" === i.style.display &&
              ...
              (c[d] =
                ...
                (l = le[a]) ||
                  ...
                  "none" === l && (l = "block"),
                  (le[a] = l)))))
          : "none" !== n && ((c[d] = "none"), Q.set(i, "display", n)));
  ...
  function me(e, t) {
    var n =
      void 0 !== e.getElementsByTagName
        ...
        : [];
    return void 0 === t || (t && E(e, t)) ? _.merge([e], n) : n;
  }
  function ve(e, t) {
  ...
  function be(e, t, n, i, o) {
    ...
    for (u.textContent = "", f = 0; (s = p[f++]); )
      if (i && -1 < _.inArray(s, i)) o && o.push(s);
        ...
        ((c = oe(s)), (r = me(u.appendChild(s), "script")), c && ve(r), n)
      )
  ...
  function Ee(e, o, s) {
    s
        ...
        _.event.add(e, o, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[o]) {
              if (i.length)
                (_.event.special[o] || {}).delegateType && e.stopPropagation();
              else if (
                ((i = a.call(arguments)),
                Q.set(this, o, i),
                (t = s(this, o)),
      ...
      : void 0 === Q.get(e, o) && _.event.add(e, o, Ce);
  }
  (_.event = {
    global: {},
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            pe.test(t.type) && t.click && E(t, "input") && Ee(t, "click", Ce),
            !1
          );
        },
        trigger: function (e) {
  ...
  function je(e, t) {
    ...
    if (1 === t.nodeType) {
      ...
      K.hasData(e) && ((s = K.access(e)), (r = _.extend({}, s)), K.set(t, r));
    }
  }
  function Ne(n, i, o, s) {
    i = m(i);
    ...
    if (h || (1 < u && "string" == typeof f && !y.checkClone && Ae.test(f)))
      return n.each(function (e) {
        var t = n.eq(e);
        h && (i[0] = f.call(this, e, t.html())), Ne(t, i, o, s);
      });
    if (
      u &&
      ...
      for (a = (r = _.map(me(e, "script"), Oe)).length; d < u; d++)
        (l = e),
          d !== p &&
            ((l = _.clone(l, !0, !0)), a && _.merge(r, me(l, "script"))),
          o.call(n[d], l, d);
      if (a)
        for (c = r[r.length - 1].ownerDocument, _.map(r, Le), d = 0; d < a; d++)
          (l = r[d]),
            he.test(l.type || "") &&
  ...
  function Ie(e, t, n) {
    for (var i, o = t ? _.filter(t, e) : e, s = 0; null != (i = o[s]); s++)
  ...
  _.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (s = s || me(e), r = r || me(d), i = 0, o = s.length; i < o; i++)
            je(s[i], r[i]);
        else je(e, d);
      return (
        0 < (r = me(d, "script")).length && ve(r, !u && me(e, "script")), d
      );
    },
      ...
      replaceWith: function () {
        ...
        return Ne(
          ...
          function (e) {
            ...
            _.inArray(this, n) < 0 &&
              (_.cleanData(me(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
    ...
    _.each(
      ...
      function (e, r) {
        _.fn[e] = function (e) {
          for (var t, n = [], i = _(e), o = i.length - 1, s = 0; s <= o; s++)
  ...
  function Qe() {
    ...
    Xe &&
      ...
      ie.appendChild(We).appendChild(Xe),
      (e = C.getComputedStyle(Xe)),
      (Me = "1%" !== e.top),
  ...
  function lt(e, t, n, i, o, s) {
    ...
    for (; r < 4; r += 2)
      "margin" === n && (l += _.css(e, n + ne[r], !0, o)),
        i
          ? ("content" === n && (l -= _.css(e, "padding" + ne[r], !0, o)),
            "margin" !== n &&
              (l -= _.css(e, "border" + ne[r] + "Width", !0, o)))
          : ((l += _.css(e, "padding" + ne[r], !0, o)),
            "padding" !== n
              ? (l += _.css(e, "border" + ne[r] + "Width", !0, o))
              : (a += _.css(e, "border" + ne[r] + "Width", !0, o)));
    return (
      !i &&
        0 <= s &&
        (l +=
  ...
  function ct(e, t, n) {
    ...
    return (
      ((!y.boxSizingReliable() && o) ||
        ...
        "auto" === r ||
        (!parseFloat(r) && "inline" === _.css(e, "display", !1, i))) &&
  ...
  _.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = nt(a)), (r = _.cssHooks[t] || _.cssHooks[a]), void 0 === n)
        )
    ...
    _.each(["height", "width"], function (e, l) {
      _.cssHooks[l] = {
        get: function (e, t, n) {
          if (t)
            return !it.test(_.css(e, "display")) ||
        ...
        set: function (e, t, n) {
          var i,
            ...
            r = (s || n) && "border-box" === _.css(e, "boxSizing", !1, o),
            a = n ? lt(e, l, n, r, o) : 0;
          return (
            r &&
              s &&
            ...
            a &&
              (i = te.exec(t)) &&
              "px" !== (i[3] || "px") &&
              ((e.style[l] = t), (t = _.css(e, l))),
            at(0, t, a)
          );
        },
      };
    }),
    (_.cssHooks.marginLeft = Ze(y.reliableMarginLeft, function (e, t) {
      if (t)
        return (
    ...
    _.each({ margin: "", padding: "", border: "Width" }, function (o, s) {
      (_.cssHooks[o + s] = {
        ...
        "margin" !== o && (_.cssHooks[o + s].set = at);
    }),
    _.fn.extend({
      css: function (e, t) {
        return z(
          ...
          function (e, t, n) {
            var i,
              ...
              r = 0;
            if (Array.isArray(t)) {
              for (i = Ye(e), o = t.length; r < o; r++)
                s[t[r]] = _.css(e, t[r], !1, i);
              return s;
            }
  ...
  function xt(s, e, t) {
    ...
    for (
      ...
      if ((n = xt.prefilters[i].call(c, s, d, c.opts)))
        return (
          b(n.stop) &&
  ...
  (_.Animation = _.extend(xt, {
    ...
    tweener: function (e, t) {
      for (
        var n, i = 0, o = (e = b(e) ? ((t = e), ["*"]) : e.match(N)).length;
        i < o;
        i++
      )
        (n = e[i]),
        ...
        if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && ce([e], !0),
              p.done(function () {
                for (i in (g || ce([e]), Q.remove(e, "fxshow"), f))
                  _.style(e, i, f[i]);
              })),
              (l = wt(g ? m[i] : 0, i, p)),
              i in m ||
      ...
      stop: function (o, e, s) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in i) i[t] && i[t].stop && mt.test(t) && r(i[t]);
            for (t = n.length; t--; )
              n[t].elem !== this ||
                (null != o && n[t].queue !== o) ||
          ...
          return void 0 === e.getAttribute
            ...
            : ((1 === s && _.isXMLDoc(e)) ||
                (o =
                  ...
                  (_.expr.match.bool.test(t) ? Tt : void 0)),
              void 0 !== n
                ? null === n
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : St.test(e.nodeName) || (_t.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
    ...
    _.fn.extend({
      ...
      toggleClass: function (o, t) {
        ...
        return "boolean" == typeof t && r
          ...
          ? this.each(function (e) {
              _(this).toggleClass(o.call(this, e, Et(this), t), t);
            })
          : this.each(function () {
              var e, t, n, i;
              if (r)
                for (t = 0, n = _(this), i = $t(o); (e = i[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== o && "boolean" != s) ||
                  ((e = Et(this)) && Q.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        for (var t, n = 0, i = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + kt(Et(t)) + " ").indexOf(i))
            return !0;
        return !1;
      },
    });
      ...
      return arguments.length
        ? ((o = b(n)),
          this.each(function (e) {
            var t;
            1 === this.nodeType &&
              (null == (t = o ? n.call(this, e, _(this).val()) : n)
                ? (t = "")
                : "number" == typeof t
                ? (t += "")
                : Array.isArray(t) &&
    ...
    _.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, i, o = e.options, s = _.makeArray(t), r = o.length;
              r--;
  ...
  _.extend(_.event, {
    trigger: function (e, t, n, i) {
      ...
      if (
        3 !== n.nodeType &&
        8 !== n.nodeType &&
        !Dt.test(p + _.event.triggered) &&
        (-1 < p.indexOf(".") && ((p = (f = p.split(".")).shift()), f.sort()),
        (a = p.indexOf(":") < 0 && "on" + p),
        ((e = e[_.expando]
          ? e
          : new _.Event(p, "object" == typeof e && e)).isTrigger = i ? 2 : 3),
        (e.namespace = f.join(".")),
        ...
        if (!i && !c.noBubble && !g(n)) {
          for (
            r = c.delegateType || p, Dt.test(r + p) || (h = h.parentNode);
            h;
            h = h.parentNode
          )
            u.push(h), (s = h);
          s === (n.ownerDocument || S) &&
            u.push(s.defaultView || s.parentWindow || C);
        }
        for (o = 0; (h = u[o++]) && !e.isPropagationStopped(); )
          (d = h),
            (e.type = 1 < o ? r : c.bindType || p),
            (l =
              (Q.get(h, "events") || Object.create(null))[e.type] &&
              Q.get(h, "handle")) && l.apply(h, t),
            (l = a && h[a]) &&
              l.apply &&
              Y(h) &&
    ...
    if (Array.isArray(e) || (e.jquery && !_.isPlainObject(e)))
      ...
      for (i in e)
        !(function n(i, e, o, s) {
          ...
          else if (o || "object" !== x(e)) s(i, e);
          else for (t in e) n(i + "[" + t + "]", e[t], o, s);
        })(i, e[i], t, n);
    return o.join("&");
  }),
    _.fn.extend({
  ...
  (Vt.href = Ot.href),
    _.extend({
      ...
      ajaxSetup: function (e, t) {
        return t ? Gt(Gt(e, _.ajaxSettings), t) : Gt(_.ajaxSettings, e);
      },
      ajaxPrefilter: Qt(Xt),
      ajaxTransport: Qt(Ut),
      ajax: function (e, t) {
        ...
        m.hasContent
          ...
          : ((s = m.url.slice(u.length)),
            m.data &&
              ...
              ((u += (jt.test(u) ? "&" : "?") + m.data), delete m.data),
            !1 === m.cache &&
              ((u = u.replace(Rt, "$1")),
              (s = (jt.test(u) ? "&" : "?") + "_=" + Lt.guid++ + s)),
            (m.url = u + s)),
        m.ifModified &&
          (_.lastModified[u] &&
            T.setRequestHeader("If-Modified-Since", _.lastModified[u]),
          _.etag[u] && T.setRequestHeader("If-None-Match", _.etag[u])),
        ...
        function c(e, t, n, i) {
          ...
          h ||
            ...
            !o &&
              -1 < _.inArray("script", m.dataTypes) &&
            ...
            o
              ? (m.ifModified &&
                  ((l = T.getResponseHeader("Last-Modified")) &&
                    (_.lastModified[u] = l),
                  (l = T.getResponseHeader("etag")) && (_.etag[u] = l)),
                204 === e || "HEAD" === m.type
                  ? (c = "nocontent")
                  : 304 === e
                  ? (c = "notmodified")
            ...
            (T.status = e),
            (T.statusText = (t || c) + ""),
            o ? b.resolveWith(v, [s, c, T]) : b.rejectWith(v, [T, c, r]),
            T.statusCode(x),
            (x = void 0),
            g && y.trigger(o ? "ajaxSuccess" : "ajaxError", [T, m, o ? s : r]),
            w.fireWith(v, [T, c]),
            g &&
  ...
  _.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = tn.pop() || _.expando + "_" + Lt.guid++;
      return (this[e] = !0), e;
    },
  }),
    ...
    (_.fn.load = function (e, t, n) {
      var i,
        ...
        a = e.indexOf(" ");
      return (
        -1 < a && ((i = kt(e.slice(a))), (e = e.slice(0, a))),
        b(t)
          ? ((n = t), (t = void 0))
        ...
        0 < r.length &&
          _.ajax({ url: e, type: o || "GET", dataType: "html", data: t })
            .done(function (e) {
              (s = arguments),
                r.html(i ? _("<div>").append(_.parseHTML(e)).find(i) : e);
            })
            .always(
              n &&
                function (e, t) {
    ...
    _.each(["top", "left"], function (e, n) {
      _.cssHooks[n] = Ze(y.pixelPosition, function (e, t) {
        if (t)
          return (t = Ge(e, n)), Ue.test(t) ? _(e).position()[n] + "px" : t;
      });
    }),
    _.each({ Height: "height", Width: "width" }, function (r, a) {
      _.each(
  ...
  return (
    (_.noConflict = function (e) {
      return C.$ === _ && (C.$ = rn), e && C.jQuery === _ && (C.jQuery = sn), _;
    }),
    void 0 === e && (C.jQuery = C.$ = _),
    _
  );
}),
  (function (e, t) {
    ...
    function y(e, t) {
      ...
      if ((e !== l && t !== l) || i.contains(o))
        return "BODY" === (a = (r = l).nodeName) ||
          ...
          : l;
      var c = d(e);
      return c.host ? y(c.host, t) : y(e, d(t).host);
    }
    function x(e, t) {
      var n =
    ...
    function f(e, t, n, i, o) {
      var s,
        ...
        l,
        c,
        d = 4 < arguments.length && void 0 !== o && o,
        u = { top: 0, left: 0 },
        p = d ? $(e) : y(e, m(t));
      "viewport" === i
        ? (u = (function (e, t) {
        ...
        : ((s = void 0),
          ...
          (function e(t) {
            ...
            ? (u = r)
            : ((l = (a = T(e.ownerDocument)).height),
              (c = a.width),
              (u.top += r.top - r.marginTop),
              (u.bottom = l + r.top),
              (u.left += r.left - r.marginLeft),
              (u.right = c + r.left)));
      var f = "number" == typeof (n = n || 0);
      return (
        (u.left += f ? n : n.left || 0),
        (u.top += f ? n : n.top || 0),
        (u.right -= f ? n : n.right || 0),
        (u.bottom -= f ? n : n.bottom || 0),
        u
      );
    }
    function p(e, t, i, n, o, s) {
      ...
      var a = f(i, n, r, o),
        ...
        c = Object.keys(l)
          .map(function (e) {
            return S({ key: e }, l[e], { area: (t = l[e]).width * t.height });
            var t;
          })
          .sort(function (e, t) {
    ...
    function z(e, t) {
      ...
      var i = e.offsets,
        ...
        p = t ? (d || u || l % 2 == c % 2 ? r : a) : n,
        f = t ? r : n;
      return {
        left: p(l % 2 == 1 && c % 2 == 1 && !u && t ? o.left - 1 : o.left),
        top: f(o.top),
        bottom: f(o.bottom),
        right: p(o.right),
      };
    ...
    var Z = {
        ...
        modifiers: {
            ...
            fn: function (e) {
              ...
              return (
                d &&
                  ...
                  (i = t.popper),
                  (r = (o = -1 !== ["bottom", "top"].indexOf(c))
                    ? "width"
                    : "height"),
                  (a = {
                    start: C({}, (s = o ? "left" : "top"), n[s]),
                    end: C({}, s, n[s] + n[r] - i[r]),
                  }),
                  (e.offsets.popper = S({}, i, a[d]))),
                e
              );
            },
          },
          ...
          arrow: {
            ...
            fn: function (e, t) {
              ...
              var o = e.placement.split("-")[0],
                ...
                f = l ? "bottom" : "right",
                h = P(i)[c];
              a[f] - h < r[u] && (e.offsets.popper[u] -= r[u] - (a[f] - h)),
                a[u] + h > r[f] && (e.offsets.popper[u] += a[u] + h - r[f]),
                (e.offsets.popper = _(e.offsets.popper));
              var g = a[u] + a[c] / 2 - h / 2,
                m = w(e.instance.popper),
                v = parseFloat(m["margin" + d]),
                y = parseFloat(m["border" + d + "Width"]),
                b = g - e.offsets.popper[u] - v - y,
                b = Math.max(Math.min(r[c] - h, b), 0);
              return (
                (e.arrowElement = i),
                (e.offsets.arrow =
                  (C((n = {}), u, Math.round(b)), C(n, p, ""), n)),
                e
              );
            },
            element: "[x-arrow]",
          ...
          flip: {
            ...
            enabled: !0,
            fn: function (m, v) {
              if (N(m.instance.modifiers, "inner")) return m;
              ...
              return (
                T.forEach(function (e, t) {
                  if (b !== e || T.length === t + 1) return m;
                  (b = m.placement.split("-")[0]), (w = D(b));
                  var n,
                    i = m.offsets.popper,
                    o = m.offsets.reference,
                    s = Math.floor,
                    r =
                      ("left" === b && s(i.right) > s(o.left)) ||
                      ("right" === b && s(i.left) < s(o.right)) ||
                      ("top" === b && s(i.bottom) > s(o.top)) ||
                      ("bottom" === b && s(i.top) < s(o.bottom)),
                    a = s(i.left) < s(y.left),
                    l = s(i.right) > s(y.right),
                    c = s(i.top) < s(y.top),
                    d = s(i.bottom) > s(y.bottom),
                    u =
                      ("left" === b && a) ||
                      ("right" === b && l) ||
                      ("top" === b && c) ||
                  ...
                  (r || u || g) &&
                    ...
                    (m.offsets.popper = S(
                      {},
                      m.offsets.popper,
                      O(m.instance.popper, m.offsets.reference, m.placement)
                    )),
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var r,
                a,
                l = void 0 !== s ? s : t.gpuAcceleration,
                c = b(e.instance.popper),
                d = k(c),
                u = { position: o.position },
                p = z(e, window.devicePixelRatio < 2 || !B),
    ...
    function ee(e, t) {
      ...
      l(this, ee),
        ...
        (this.options = S({}, ee.Defaults, i)),
        (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
        (this.reference = e && e.jquery ? e[0] : e),
        (this.popper = t && t.jquery ? t[0] : t),
        (this.options.modifiers = {}),
        Object.keys(S({}, ee.Defaults.modifiers, i.modifiers)).forEach(
          function (e) {
        ...
        (this.modifiers = Object.keys(this.options.modifiers)
          .map(function (e) {
            return S({ name: e }, n.options.modifiers[e]);
          })
          .sort(function (e, t) {
  ...
  (function (e, t) {
      ...
      d = (function () {
        ...
        return (
          ...
          (e._triggerCloseEvent = function (e) {
            var t = h.Event("close.bs.alert");
            return h(e).trigger(t), t;
          }),
          (e._removeElement = function (t) {
            var e,
              n = this;
            h(t).removeClass("show"),
              h(t).hasClass("fade")
          ...
          (e._destroyElement = function (e) {
            h(e).detach().trigger("closed.bs.alert").remove();
          }),
    ...
    h(document).on(
      ...
      (h.fn[s] = d._jQueryInterface),
      (h.fn[s].Constructor = d),
      (h.fn[s].noConflict = function () {
        return (h.fn[s] = c), d._jQueryInterface;
      });
    var p = "button",
      f = "bs.button",
      m = h.fn[p],
        ...
        return (
          (e.toggle = function () {
            var e,
              ...
              n = !0,
              i = !0,
              o = h(this._element).closest('[data-toggle="buttons"]')[0];
            !o ||
              ((e = this._element.querySelector(b)) &&
                ("radio" === e.type &&
                  (e.checked && this._element.classList.contains(v)
                    ? (n = !1)
                    : (t = o.querySelector(".active")) && h(t).removeClass(v)),
                n &&
              ...
              this._element.hasAttribute("disabled") ||
                ...
                n && h(this._element).toggleClass(v));
          }),
          (e.dispose = function () {
          ...
          (n._jQueryInterface = function (t) {
            return this.each(function () {
              var e = h(this).data(f);
              e || ((e = new n(this)), h(this).data(f, e)),
                "toggle" === t && e[t]();
            });
          }),
          r(n, null, [
    ...
    h(document)
      .on("click.bs.button.data-api", y, function (e) {
        var t = e.target,
          n = t;
        if (
          (h(t).hasClass("btn") || (t = h(t).closest(".btn")[0]),
          ...
          "LABEL" === n.tagName &&
            ...
            "checkbox" === i.type &&
            e.preventDefault(),
            w._jQueryInterface.call(h(t), "toggle");
        }
      })
      ...
      h(window).on("load.bs.button.data-api", function () {
        for (
          var e = [].slice.call(
      ...
      (h.fn[p] = w._jQueryInterface),
      (h.fn[p].Constructor = w),
      (h.fn[p].noConflict = function () {
        return (h.fn[p] = m), w._jQueryInterface;
      });
    var x = "carousel",
      T = "bs.carousel",
      C = "." + T,
        ...
        return (
          ...
          (e.to = function (e) {
            ...
            if (!(e > this._items.length - 1 || e < 0))
              if (this._isSliding)
                h(this._element).one(A, function () {
                  return t.to(e);
                });
              else {
          ...
          (e.dispose = function () {
            h(this._element).off(C),
              h.removeData(this._element, T),
              (this._items = null),
              (this._config = null),
              (this._element = null),
              (this._interval = null),
          ...
          (e._getConfig = function (e) {
            return (e = l(l({}, _), e)), g.typeCheckConfig(x, e, k), e;
          }),
          ...
          (e._addEventListeners = function () {
            ...
            this._config.keyboard &&
              h(this._element).on("keydown.bs.carousel", function (e) {
                return t._keydown(e);
              }),
          ...
          (e._addTouchEventListeners = function () {
            ...
            this._touchSupported &&
              ((e = function (e) {
                n._pointerEvent && O[e.originalEvent.pointerType.toUpperCase()]
              ...
              h(this._element.querySelectorAll(".carousel-item img")).on(
              ...
              this._pointerEvent
                ? (h(this._element).on("pointerdown.bs.carousel", e),
                  h(this._element).on("pointerup.bs.carousel", t),
                  this._element.classList.add("pointer-event"))
                : (h(this._element).on("touchstart.bs.carousel", e),
                  h(this._element).on("touchmove.bs.carousel", function (e) {
                    var t;
                  ...
                  h(this._element).on("touchend.bs.carousel", t)));
          }),
          ...
          (e._slide = function (e, t) {
            var n,
              ...
              r,
              a = this,
              l = this._element.querySelector(D),
            ...
            d && h(d).hasClass(P)
              ? (this._isSliding = !1)
              : this._triggerSlideEvent(d, f).isDefaultPrevented() ||
                (l &&
                  d &&
                  ((this._isSliding = !0),
                  p && this.pause(),
                  ...
                  h(this._element).hasClass("slide")
                    ? (h(d).addClass(i),
                      g.reflow(d),
                      h(l).addClass(n),
                      h(d).addClass(n),
                      (s = parseInt(d.getAttribute("data-interval"), 10))
                        ...
                        : (this._config.interval =
                            this._config.defaultInterval ||
                            this._config.interval),
                      (r = g.getTransitionDurationFromElement(l)),
                      h(l)
                        .one(g.TRANSITION_END, function () {
                          h(d)
                            .removeClass(n + " " + i)
                            .addClass(P),
                            h(l).removeClass(P + " " + i + " " + n),
                            (a._isSliding = !1),
                            setTimeout(function () {
                              return h(a._element).trigger(o);
                            }, 0);
                        })
          ...
          (s._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new s(this, t)), h(this).data(T, e)),
                "number" == typeof i)
              )
                e.to(i);
          ...
          (s._dataApiClickHandler = function (e) {
            ...
            !o ||
              ((t = h(o)[0]) &&
                h(t).hasClass("carousel") &&
                ((n = l(l({}, h(t).data()), h(this).data())),
                (i = this.getAttribute("data-slide-to")) && (n.interval = !1),
                s._jQueryInterface.call(h(t), n),
                i && h(t).data(T).to(i),
                e.preventDefault()));
          }),
          r(s, null, [
    ...
    h(document).on(
      ...
      h(window).on("load.bs.carousel.data-api", function () {
        for (
          var e = [].slice.call(
      ...
      (h.fn[x] = L._jQueryInterface),
      (h.fn[x].Constructor = L),
      (h.fn[x].noConflict = function () {
        return (h.fn[x] = S), L._jQueryInterface;
      });
    var j = "collapse",
      N = "bs.collapse",
      I = h.fn[j],
      ...
      W = (function () {
        ...
        return (
          (e.toggle = function () {
            h(this._element).hasClass(F) ? this.hide() : this.show();
          }),
          (e.show = function () {
            var e,
              t,
            ...
            this._isTransitioning ||
              ...
              (this._parent &&
                ...
                (e = null),
              (e &&
                (t = h(e).not(this._selector).data(N)) &&
                t._isTransitioning) ||
                ((n = h.Event("show.bs.collapse")),
                h(this._element).trigger(n),
                n.isDefaultPrevented() ||
                  (e &&
                    (a._jQueryInterface.call(h(e).not(this._selector), "hide"),
                    t || h(e).data(N, null)),
                  (i = this._getDimension()),
                  h(this._element).removeClass(q).addClass(R),
                  ...
                  h(this._element)
                    .one(g.TRANSITION_END, function () {
                      h(r._element)
                        ...
                        h(r._element).trigger("shown.bs.collapse");
                    })
          ...
          (e.hide = function () {
            var e = this;
            if (!this._isTransitioning && h(this._element).hasClass(F)) {
                ...
                if (0 < i)
                  for (var o = 0; o < i; o++) {
                    var s = this._triggerArray[o],
                      r = g.getSelectorFromElement(s);
                    null !== r &&
                      (h([].slice.call(document.querySelectorAll(r))).hasClass(
                        F
                      ) ||
                        h(s).addClass(z).attr("aria-expanded", !1));
                  }
                this.setTransitioning(!0);
                this._element.style[n] = "";
          ...
          (e._getConfig = function (e) {
            return (
              ((e = l(l({}, H), e)).toggle = Boolean(e.toggle)),
              g.typeCheckConfig(j, e, M),
              e
            );
          }),
          ...
          (e._addAriaAndCollapsedClass = function (e, t) {
            var n = h(e).hasClass(F);
            t.length && h(t).toggleClass(z, !n).attr("aria-expanded", n);
          }),
    ...
    h(document).on("click.bs.collapse.data-api", B, function (e) {
      ...
      h(i).each(function () {
        var e = h(this),
          t = e.data(N) ? "toggle" : n.data();
        W._jQueryInterface.call(e, t);
      });
    }),
      (h.fn[j] = W._jQueryInterface),
      (h.fn[j].Constructor = W),
      (h.fn[j].noConflict = function () {
        return (h.fn[j] = I), W._jQueryInterface;
      });
    var X = "dropdown",
      U = "bs.dropdown",
      Y = "." + U,
        ...
        return (
          (e.toggle = function () {
            ...
            this._element.disabled ||
              h(this._element).hasClass(te) ||
              ((e = h(this._menu).hasClass(ne)),
              c._clearMenus(),
              e || this.show(!0));
          }),
          (e.show = function (e) {
            if (
              ...
              !(
                this._element.disabled ||
                h(this._element).hasClass(te) ||
                h(this._menu).hasClass(ne)
              ))
            ) {
              var t = { relatedTarget: this._element },
                n = h.Event("show.bs.dropdown", t),
                i = c._getParentFromElement(this._element);
              if ((h(i).trigger(n), !n.isDefaultPrevented())) {
                if (!this._inNavbar && e) {
                  if (void 0 === u)
                    throw new TypeError(
                ...
                "ontouchstart" in document.documentElement &&
                  0 === h(i).closest(".navbar-nav").length &&
                  h(document.body).children().on("mouseover", null, h.noop),
                  this._element.focus(),
                  this._element.setAttribute("aria-expanded", !0),
                  h(this._menu).toggleClass(ne),
                  h(i).toggleClass(ne).trigger(h.Event("shown.bs.dropdown", t));
              }
            }
          }),
          (e.hide = function () {
            ...
            this._element.disabled ||
              ...
              t.isDefaultPrevented() ||
                ...
                h(this._menu).toggleClass(ne),
                h(n).toggleClass(ne).trigger(h.Event(Z, e))));
          }),
          (e.dispose = function () {
            h.removeData(this._element, U),
              h(this._element).off(Y),
              (this._element = null),
          ...
          (e._addEventListeners = function () {
            var t = this;
            h(this._element).on("click.bs.dropdown", function (e) {
          ...
          (e._getConfig = function (e) {
            return (
              (e = l(
                l(l({}, this.constructor.Default), h(this._element).data()),
                e
              )),
              g.typeCheckConfig(X, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass("dropup")
                ? (t = h(this._menu).hasClass(ie) ? "top-end" : "top-start")
                : e.hasClass("dropright")
                ? (t = "right-start")
                : e.hasClass("dropleft")
                ? (t = "left-start")
                : h(this._menu).hasClass(ie) && (t = "bottom-end"),
              t
            );
          }),
                      ...
                      ((e &&
                        ...
                        s.isDefaultPrevented() ||
                          ("ontouchstart" in document.documentElement &&
                            h(document.body)
                              .children()
                              .off("mouseover", null, h.noop),
                          t[n].setAttribute("aria-expanded", "false"),
                          a._popper && a._popper.destroy(),
                          h(o).removeClass(ne),
                          h(r).removeClass(ne).trigger(h.Event(Z, l))))));
              }
          }),
            ...
            if (
              ...
              if (n || 27 !== e.which) {
                if (
                  ...
                  return (
                    27 === e.which && h(t.querySelector(oe)).trigger("focus"),
                    void h(this).trigger("click")
                  );
                var i,
                  o = [].slice
                    .call(
    ...
    h(document)
      .on(ee, oe, le._dataApiKeydownHandler)
      .on(ee, se, le._dataApiKeydownHandler)
      .on(J + " keyup.bs.dropdown.data-api", le._clearMenus)
      .on(J, oe, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
          le._jQueryInterface.call(h(this), "toggle");
      })
      .on(J, ".dropdown form", function (e) {
        e.stopPropagation();
      }),
      (h.fn[X] = le._jQueryInterface),
      (h.fn[X].Constructor = le),
      (h.fn[X].noConflict = function () {
        return (h.fn[X] = Q), le._jQueryInterface;
      });
    var ce = "modal",
      de = "bs.modal",
      ue = "." + de,
      ...
      ye = "resize" + ue,
      be = "click.dismiss" + ue,
      we = "keydown.dismiss" + ue,
      xe = "mousedown.dismiss" + ue,
      Te = "modal-open",
      Ce = "fade",
      Se = "show",
      _e = "modal-static",
      ...
      $e = (function () {
        ...
        return (
          ...
          (e.show = function (e) {
            ...
            this._isShown ||
              this._isTransitioning ||
              (h(this._element).hasClass(Ce) && (this._isTransitioning = !0),
              (t = h.Event(me, { relatedTarget: e })),
              h(this._element).trigger(t),
              this._isShown ||
                t.isDefaultPrevented() ||
                ((this._isShown = !0),
                ...
                h(this._element).on(be, '[data-dismiss="modal"]', function (e) {
                  return n.hide(e);
                }),
                h(this._dialog).on(xe, function () {
                  h(n._element).one("mouseup.dismiss.bs.modal", function (e) {
                    h(e.target).is(n._element) && (n._ignoreBackdropClick = !0);
                  });
                }),
          ...
          (e.hide = function (e) {
            ...
            e && e.preventDefault(),
              this._isShown &&
                !this._isTransitioning &&
                ((t = h.Event("hide.bs.modal")),
                h(this._element).trigger(t),
                this._isShown &&
                  !t.isDefaultPrevented() &&
                  ((this._isShown = !1),
                  (n = h(this._element).hasClass(Ce)) &&
                    (this._isTransitioning = !0),
                  this._setEscapeEvent(),
                  this._setResizeEvent(),
                  h(document).off(ve),
                  h(this._element).removeClass(Se),
                  h(this._element).off(be),
                  h(this._dialog).off(xe),
                  n
          ...
          (e._getConfig = function (e) {
            return (e = l(l({}, fe), e)), g.typeCheckConfig(ce, e, he), e;
          }),
          (e._triggerBackdropTransition = function () {
            var e = this;
            if ("static" === this._config.backdrop) {
              var t = h.Event("hidePrevented.bs.modal");
          ...
          (e._showElement = function (e) {
            ...
            (this._element.parentNode &&
              ...
              h(this._dialog).hasClass("modal-dialog-scrollable") && i
                ? (i.scrollTop = 0)
                : (this._element.scrollTop = 0),
              n && g.reflow(this._element),
              h(this._element).addClass(Se),
              this._config.focus && this._enforceFocus();
            function o() {
              t._config.focus && t._element.focus(),
                (t._isTransitioning = !1),
                h(t._element).trigger(r);
            }
            var s,
              r = h.Event("shown.bs.modal", { relatedTarget: e });
            n
              ? ((s = g.getTransitionDurationFromElement(this._dialog)),
                h(this._dialog)
          ...
          (e._enforceFocus = function () {
            ...
            h(document)
              ...
              .on(ve, function (e) {
                document !== e.target &&
                  t._element !== e.target &&
                  0 === h(t._element).has(e.target).length &&
                  t._element.focus();
              });
          }),
          (e._setEscapeEvent = function () {
            var t = this;
            this._isShown
              ? h(this._element).on(we, function (e) {
              ...
              : this._isShown || h(this._element).off(we);
          }),
          (e._setResizeEvent = function () {
            var t = this;
            this._isShown
              ? h(window).on(ye, function (e) {
          ...
          (e._hideModal = function () {
            ...
            (this._element.style.display = "none"),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                h(document.body).removeClass(Te),
                  e._resetAdjustments(),
                  e._resetScrollbar(),
                  h(e._element).trigger(ge);
              });
          }),
          (e._removeBackdrop = function () {
            this._backdrop &&
              (h(this._backdrop).remove(), (this._backdrop = null));
          }),
          (e._showBackdrop = function (e) {
            var t,
              n,
              i = this,
              o = h(this._element).hasClass(Ce) ? Ce : "";
            if (this._isShown && this._config.backdrop) {
              if (
                ...
                h(this._element).on(be, function (e) {
              ...
              !this._isShown && this._backdrop
                ? (h(this._backdrop).removeClass(Se),
                  (t = function () {
                    i._removeBackdrop(), e && e();
                  }),
                  h(this._element).hasClass(Ce)
          ...
          (e._resetScrollbar = function () {
            ...
            h(t).each(function (e, t) {
              ...
              void 0 !== n &&
                h(t).css("margin-right", n).removeData("margin-right");
            });
          ...
          (o._jQueryInterface = function (n, i) {
            return this.each(function () {
              var e = h(this).data(de),
                t = l(
                  l(l({}, fe), h(this).data()),
                  "object" == typeof n && n ? n : {}
                );
              if (
                (e || ((e = new o(this, t)), h(this).data(de, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    h(document).on(
      ...
      function (e) {
        ...
        var o = h(t).data(de)
          ? "toggle"
          : l(l({}, h(t).data()), h(this).data());
        ("A" !== this.tagName && "AREA" !== this.tagName) || e.preventDefault();
        var s = h(t).one(me, function (e) {
          e.isDefaultPrevented() ||
            s.one(ge, function () {
              h(n).is(":visible") && n.focus();
            });
        });
        $e._jQueryInterface.call(h(t), o, this);
      }
    ),
      (h.fn[ce] = $e._jQueryInterface),
      (h.fn[ce].Constructor = $e),
      (h.fn[ce].noConflict = function () {
        return (h.fn[ce] = pe), $e._jQueryInterface;
      });
    var Ae = [
        "background",
        "cite",
            ...
            i.forEach(function (e) {
              !(function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === Ae.indexOf(n) ||
                    Boolean(e.nodeValue.match(De) || e.nodeValue.match(Oe))
                  );
                for (
      ...
      Ke = (function () {
        ...
        return (
          ...
          (e.toggle = function (e) {
            if (this._isEnabled)
              if (e) {
                ...
                if (h(this.getTipElement()).hasClass(Ye))
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              o.setAttribute("id", s),
                ...
                this.setContent(),
                this.config.animation && h(o).addClass(Ue);
              var r =
              ...
              h(this.tip).hasClass(Ue)
                ? ((c = g.getTransitionDurationFromElement(this.tip)),
                  h(this.tip).one(g.TRANSITION_END, d).emulateTransitionEnd(c))
                : d();
            }
          }),
          (e.hide = function (e) {
            function t() {
              i._hoverState !== We &&
                ...
                h(i.element).trigger(i.constructor.Event.HIDDEN),
            ...
            var n,
              ...
              s = h.Event(this.constructor.Event.HIDE);
            h(this.element).trigger(s),
              s.isDefaultPrevented() ||
                (h(o).removeClass(Ye),
                "ontouchstart" in document.documentElement &&
                  h(document.body).children().off("mouseover", null, h.noop),
                (this._activeTrigger.click = !1),
                (this._activeTrigger[Qe] = !1),
                (this._activeTrigger[Ve] = !1),
                h(this.tip).hasClass(Ue)
                  ? ((n = g.getTransitionDurationFromElement(o)),
                    h(o).one(g.TRANSITION_END, t).emulateTransitionEnd(n))
                  : t(),
                (this._hoverState = ""));
          }),
          (e.update = function () {
          ...
          (e.addAttachmentClass = function (e) {
            h(this.getTipElement()).addClass(Me + "-" + e);
          }),
          (e.getTipElement = function () {
            return (
              (this.tip = this.tip || h(this.config.template)[0]), this.tip
            );
          }),
          (e.setContent = function () {
            var e = this.getTipElement();
            this.setElementContent(
              h(e.querySelectorAll(".tooltip-inner")),
              this.getTitle()
            ),
              h(e).removeClass(Ue + " " + Ye);
          }),
          (e.setElementContent = function (e, t) {
            "object" != typeof t || (!t.nodeType && !t.jquery)
              ? this.config.html
                ? (this.config.sanitize &&
                    (t = Le(t, this.config.whiteList, this.config.sanitizeFn)),
                  e.html(t))
                : e.text(t)
              : this.config.html
          ...
          (e._getContainer = function () {
            return !1 === this.config.container
              ...
              : h(document).find(this.config.container);
          }),
          ...
          (e._enter = function (e, t) {
            ...
            (t = t || h(e.currentTarget).data(n)) ||
              ((t = new this.constructor(
                e.currentTarget,
                this._getDelegateConfig()
              )),
              h(e.currentTarget).data(n, t)),
              e && (t._activeTrigger["focusin" === e.type ? Qe : Ve] = !0),
              h(t.getTipElement()).hasClass(Ye) || t._hoverState === We
                ? (t._hoverState = We)
          ...
          (e._leave = function (e, t) {
            ...
            (t = t || h(e.currentTarget).data(n)) ||
              ...
              h(e.currentTarget).data(n, t)),
              e && (t._activeTrigger["focusout" === e.type ? Qe : Ve] = !1),
          ...
          (e._getConfig = function (e) {
            ...
            return (
              ...
              g.typeCheckConfig(je, e, this.constructor.DefaultType),
              e.sanitize &&
                (e.template = Le(e.template, e.whiteList, e.sanitizeFn)),
              e
            );
          }),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var e = h(this).data(Ne),
                t = "object" == typeof n && n;
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), h(this).data(Ne, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (h.fn[je] = Ke._jQueryInterface),
      (h.fn[je].Constructor = Ke),
      (h.fn[je].noConflict = function () {
        return (h.fn[je] = He), Ke._jQueryInterface;
      });
    var Ge = "popover",
      Ze = "bs.popover",
      Je = "." + Ze,
      ...
      rt = (function (e) {
        ...
        return (
          ...
          (o.addAttachmentClass = function (e) {
            h(this.getTipElement()).addClass(tt + "-" + e);
          }),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var e = h(this).data(Ze),
                t = "object" == typeof n ? n : null;
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), h(this).data(Ze, e)),
                "string" == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (h.fn[Ge] = rt._jQueryInterface),
      (h.fn[Ge].Constructor = rt),
      (h.fn[Ge].noConflict = function () {
        return (h.fn[Ge] = et), rt._jQueryInterface;
      });
    var at = "scrollspy",
      lt = "bs.scrollspy",
      ct = "." + lt,
      ...
      yt = (function () {
        function n(e, t) {
          ...
          (this._element = e),
            ...
            h(this._scrollElement).on("scroll.bs.scrollspy", function (e) {
              return n._process(e);
            }),
            this.refresh(),
            this._process();
        ...
        return (
              ...
              [].slice
                ...
                .map(function (e) {
                  ...
                  if ((n && (t = document.querySelector(n)), t)) {
                    ...
                    if (i.width || i.height) return [h(t)[o]().top + s, n];
                  }
                  return null;
                })
                .filter(function (e) {
          ...
          (e.dispose = function () {
            h.removeData(this._element, lt),
              h(this._scrollElement).off(ct),
              (this._element = null),
          ...
          (e._getConfig = function (e) {
            ...
            return (
              "string" !=
                typeof (e = l(l({}, ut), "object" == typeof e && e ? e : {}))
                  .target &&
                g.isElement(e.target) &&
                ((t = h(e.target).attr("id")) ||
                  ((t = g.getUID(at)), h(e.target).attr("id", t)),
                (e.target = "#" + t)),
              g.typeCheckConfig(at, e, pt),
              e
            );
          }),
          ...
          (e._activate = function (t) {
            ...
            n.hasClass("dropdown-item")
              ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(ft),
                n.addClass(ft))
              : (n.addClass(ft),
                n
                  .parents(ht)
                  .prev(gt + ", " + mt)
                  .addClass(ft),
                n.parents(ht).prev(".nav-item").children(gt).addClass(ft)),
              h(this._scrollElement).trigger("activate.bs.scrollspy", {
                relatedTarget: t,
              });
          }),
          (e._clear = function () {
    ...
    h(window).on("load.bs.scrollspy.data-api", function () {
      ...
      (h.fn[at] = yt._jQueryInterface),
      (h.fn[at].Constructor = yt),
      (h.fn[at].noConflict = function () {
        return (h.fn[at] = dt), yt._jQueryInterface;
      });
    var bt = "bs.tab",
      wt = h.fn.tab,
      xt = "active",
      ...
      St = (function () {
        ...
        return (
          (e.show = function () {
            ...
            (this._element.parentNode &&
              this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
              h(this._element).hasClass(xt)) ||
              h(this._element).hasClass("disabled") ||
              ((t = h(this._element).closest(".nav, .list-group")[0]),
              (n = g.getSelectorFromElement(this._element)),
              t &&
                ((i = "UL" === t.nodeName || "OL" === t.nodeName ? Ct : Tt),
                (o = (o = h.makeArray(h(t).find(i)))[o.length - 1])),
              (s = h.Event("hide.bs.tab", { relatedTarget: this._element })),
              (r = h.Event("show.bs.tab", { relatedTarget: o })),
              o && h(o).trigger(s),
              h(this._element).trigger(r),
              r.isDefaultPrevented() ||
                s.isDefaultPrevented() ||
                (n && (e = document.querySelector(n)),
                this._activate(this._element, t),
                (a = function () {
                  var e = h.Event("hidden.bs.tab", {
                      relatedTarget: l._element,
                    }),
                    t = h.Event("shown.bs.tab", { relatedTarget: o });
                  h(o).trigger(e), h(l._element).trigger(t);
                }),
                e ? this._activate(e, e.parentNode, a) : a()));
          }),
          (e.dispose = function () {
            h.removeData(this._element, bt), (this._element = null);
          }),
          (e._activate = function (e, t, n) {
            ...
            r && a
              ? ((o = g.getTransitionDurationFromElement(r)),
                h(r)
                  .removeClass("show")
          ...
          (e._transitionComplete = function (e, t, n) {
            ...
            t &&
              (h(t).removeClass(xt),
              (i = h(t.parentNode).find("> .dropdown-menu .active")[0]) &&
                h(i).removeClass(xt),
              ...
              e.parentNode &&
                h(e.parentNode).hasClass("dropdown-menu") &&
                ((o = h(e).closest(".dropdown")[0]) &&
                  ((s = [].slice.call(o.querySelectorAll(".dropdown-toggle"))),
                  h(s).addClass(xt)),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              var e = h(this),
                t = e.data(bt);
              if (
                (t || ((t = new i(this)), e.data(bt, t)), "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
                t[n]();
    ...
    h(document).on(
      ...
      function (e) {
        e.preventDefault(), St._jQueryInterface.call(h(this), "show");
      }
    ),
      (h.fn.tab = St._jQueryInterface),
      (h.fn.tab.Constructor = St),
      (h.fn.tab.noConflict = function () {
        return (h.fn.tab = wt), St._jQueryInterface;
      });
    var _t = "toast",
      kt = "bs.toast",
      Et = "." + kt,
        ...
        return (
          (e.show = function () {
            var e,
              t,
              n = this,
              i = h.Event("show.bs.toast");
            h(this._element).trigger(i),
              i.isDefaultPrevented() ||
                (this._config.animation && this._element.classList.add("fade"),
                (e = function () {
                  n._element.classList.remove(Dt),
                    n._element.classList.add(Pt),
                    h(n._element).trigger("shown.bs.toast"),
                    n._config.autohide &&
          ...
          (e.hide = function () {
            var e;
            this._element.classList.contains(Pt) &&
              ((e = h.Event("hide.bs.toast")),
              h(this._element).trigger(e),
          ...
          (e.dispose = function () {
            clearTimeout(this._timeout),
              ...
              h(this._element).off(At),
              h.removeData(this._element, kt),
              (this._element = null),
              (this._config = null);
          }),
          (e._getConfig = function (e) {
          ...
          (e._setListeners = function () {
            var e = this;
            h(this._element).on(At, '[data-dismiss="toast"]', function () {
              return e.hide();
            });
          }),
          (e._close = function () {
            function e() {
              n._element.classList.add("hide"),
                h(n._element).trigger("hidden.bs.toast");
            }
            var t,
              n = this;
            this._element.classList.remove(Pt),
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (t ||
                  ((t = new i(this, "object" == typeof n && n)), e.data(kt, t)),
                "string" == typeof n)
              ) {
                if (void 0 === t[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (h.fn[_t] = jt._jQueryInterface),
      (h.fn[_t].Constructor = jt),
      (h.fn[_t].noConflict = function () {
        return (h.fn[_t] = $t), jt._jQueryInterface;
      }),
      (e.Alert = d),
      (e.Button = w),
      (e.Carousel = L),
            ...
            (i.$slides
              ...
              .each(function (e) {
                ...
                c(this).attr({
                  ...
                  -1 !== n &&
                    ((t = "slick-slide-control" + i.instanceUid + n),
                    c("#" + t).length &&
        ...
        if (
          (!0 === s.options.centerMode
            ...
            : ((t = s.options.infinite
              ...
              !0 === s.options.fade &&
                (0 < t && t--, n <= s.slideCount && n++)),
          (e = s.$slider.find(".slick-slide").slice(t, n)),
          "anticipated" === s.options.lazyLoad)
        )
          for (
            var o = t - 1, r = n, a = s.$slider.find(".slick-slide"), l = 0;
          ...
          !0 === s.options.centerMode
            ? ((i = s.options.slidesToShow % 2 == 0 ? 1 : 0),
              ...
              !0 === s.options.infinite &&
                ...
                0 === e
                  ? r
                      .eq(r.length - 1 - s.options.slidesToShow)
                      .addClass("slick-center")
                  : e === s.slideCount - 1 &&
                    r.eq(s.options.slidesToShow).addClass("slick-center")),
            ...
            : ((n = s.slideCount % s.options.slidesToShow),
              ...
              s.slideCount - e < s.options.slidesToShow
                ? r
                    .slice(t - (s.options.slidesToShow - n), t + n)
                    .addClass("slick-active")
                    .attr("aria-hidden", "false")
                : r
      ...
      g.extend(i.prototype, {
        ...
        createSlide: function (e) {
          ...
          return (
            ...
            !n.slides[e] &&
              ...
              (n.slides[e] = g.extend(!0, {}, n.group[i], {
                pos: e,
                $slide: t,
                isLoaded: !1,
              })),
          ...
          return (
            ...
            (!(d.isClosing = !0) === d.trigger("beforeClose", e)
              ...
              : (d.removeEvents(),
                ...
                (o = g.isNumeric(t) ? t : i ? u.opts.animationDuration : 0),
                u.$slide.removeClass(
                  "fancybox-slide--complete fancybox-slide--next fancybox-slide--previous fancybox-animated"
                ),
                !0 !== e ? g.fancybox.stop(u.$slide) : (i = !1),
        ...
        trigger: function (e, t) {
          ...
          if (
            ...
            i.unshift(this),
            g.isFunction(o.opts[e]) && (n = o.opts[e].apply(o, i)),
            !1 === n)
          )
            return n;
          "afterClose" !== e && this.$refs
            ? this.$refs.container.trigger(e + ".fb", i)
            : s.trigger(e + ".fb", i);
        },
        ...
        (g.fancybox = {
          ...
          use3d:
            ...
            l.getComputedStyle &&
              ...
              l.getComputedStyle(h).getPropertyValue("transform") &&
  ...
  (function (g, l, m) {
    ...
    function u(e) {
      for (
        ...
        (i = g.getComputedStyle(t)["overflow-x"]),
        (o =
    ...
    (n.prototype.destroy = function () {
        ...
        if (
          ...
          (t.realPoints = t.startPoints = d(e)),
            t.startPoints.length &&
              ...
              (t.contentStartPos = m.fancybox.getTranslate(t.$content) || {
                top: 0,
                left: 0,
              }),
              (t.sliderStartPos = m.fancybox.getTranslate(s)),
              ...
              m(l)
                ...
                .on(
                  ...
                  m.proxy(t, "ontouchend")
                )
                .on(
                  a ? "touchmove.fb.touch" : "mousemove.fb.touch",
                  m.proxy(t, "ontouchmove")
                ),
              m.fancybox.isMobile &&
              ...
              (((t.opts || t.canPan) &&
                ...
                (1 !== t.startPoints.length && !o.hasError) ||
                  (t.canPan
                    ? (m.fancybox.stop(t.$content), (t.isPanning = !0))
                    : (t.isSwiping = !0),
        ...
        if (!0 !== n)
          "x" == n &&
            ...
            (o.requestId = y(function () {
              o.sliderLastPos &&
                (m.each(o.instance.slides, function (e, t) {
      ...
      (n.prototype.limitMovement = function () {
        var e = this.canvasWidth,
          ...
          f = Math.min(e - a, 0.5 * e - 0.5 * a),
          h = Math.min(t - l, 0.5 * t - 0.5 * l);
        return (
          0 < n && u < c && (c = u - 1 + Math.pow(-u + s + n, 0.8) || 0),
          n < 0 && c < f && (c = f + 1 - Math.pow(f - s - n, 0.8) || 0),
          0 < i && p < d && (d = p - 1 + Math.pow(-p + r + i, 0.8) || 0),
          i < 0 && d < h && (d = h + 1 - Math.pow(h - r - i, 0.8) || 0),
          { top: d, left: c }
        );
      }),
      ...
      (n.prototype.onTap = function (n) {
        function e(e) {
          var t = r.opts[e];
          if ((m.isFunction(t) && (t = t.apply(s, [r, n])), t))
            switch (t) {
              case "close":
              ...
              case "zoom":
                "image" == r.type &&
                  ...
                  (s.canPan()
                    ...
                    : s.isScaledDown()
                    ? s.scaleToActual(l, c)
                    : s.group.length < 2 && s.close(i.startEvent));
            }
        }
        var t,
          i = this,
  ...
  (function (s, n) {
    ...
    o &&
      ((i = {
        request: function (e) {
          (e = e || s.documentElement)[o.requestFullscreen](
