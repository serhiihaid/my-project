...
const servicesMenu = document.querySelector(
  "header nav ul.nav-main li.menu-open div.menu"
);

// ====================== prod-cat-expand.js ======================

// Find Prod-cat tab
const prodCatTab = document.querySelector(
  "header nav ul.nav-main li.menu-open div.menu div.prod-cat > h3"
);

// Find its span
const prodCatSpan = document.querySelector(
  "header nav ul.nav-main li.menu-open div.menu div.prod-cat > h3 > span.arrow-down"
);

// Find Prod-cat menu
const prodCatMenu = document.querySelector(
  "header nav ul.nav-main li.menu-open div.menu div.prod-cat > div"
);

// ====================== sale-expand.js ======================

// Find Sale tab
const saleTab = document.querySelector(
  "header nav ul.nav-main li.menu-open div.menu div.sale > h3"
);

// Find its span
const saleSpan = document.querySelector(
  "header nav ul.nav-main li.menu-open div.menu div.sale > h3 > span.arrow-down"
);

// Find Sale menu
const saleMenu = document.querySelector(
  "header nav ul.nav-main li.menu-open div.menu div.sale > ul"
);

// ------ event listeners ------

// Event listener: click on Prod-cat tab - show/hide Prod-cat menu
prodCatTab.addEventListener(
  "click",
  () => {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const footerSpans = document.querySelectorAll(
    "footer div.wrapper > div > h3 > span.arrow-down"
  );
